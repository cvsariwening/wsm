...
export default function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <a href="https://wa.me/6281234567890" target="_blank" class="fixed bottom-4 right-4 z-50 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition duration-300 ease-in-out" aria-label="Chat on WhatsApp">
      <!-- Ikon WhatsApp SVG -->
